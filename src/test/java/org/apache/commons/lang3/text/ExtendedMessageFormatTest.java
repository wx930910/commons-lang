...
public class ExtendedMessageFormatTest {
	...
	public static FormatFactory mockFormatFactory1() {
		FormatFactory mockInstance = mock(FormatFactory.class);
		when(mockInstance.getFormat(any(String.class), any(String.class), any(Locale.class))).thenAnswer((stubInvo) -> {
			String arguments = stubInvo.getArgument(1);
			Locale locale = stubInvo.getArgument(2);
			return !"short".equals(arguments) ? null
					: locale == null ? DateFormat.getDateInstance(DateFormat.DEFAULT)
...
//    }
	...
	public void testOverriddenBuiltinFormat() {
		...
		final Map<String, ? extends FormatFactory> dateRegistry = Collections.singletonMap("date",
				ExtendedMessageFormatTest.mockFormatFactory1());
	 ...
	 * check the formatted output matches the expected result for the parameters.
	 * 
